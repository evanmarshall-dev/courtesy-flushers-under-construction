    ...
    <section className="hero">
      <div className="flex flex-wrap justify-evenly">
        <div className="flex flex-col justify-center w-1/3 mx-auto">
          ...
          <p className="text-xl">
            We are excited for you to see what we have in the works. A new
            online experience will be coming soon.
          </p>
          <p className="text-xl">
            Please keep an eye on our social media to be the first to know when
            we go live. Also, there is some great content on there already
            &#x1F609;
          </p>
